...
class Channel {
	...
	public:
		int give_priv(class &Client); //changes operator/kick-flag or adds a user if not in the container, returns 1 if succesfull
		int rm_priv(class &Client); //changes operator/kick-flag or adds a user if not in the container, returns 1 if succesfull
